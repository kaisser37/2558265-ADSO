...
public class ListaVendedores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (vendedores.getColumnModel().getColumnCount() > 0) {
            ...
            vendedores.getColumnModel().getColumn(2).setPreferredWidth(150);
        ...
        try {
            if (datosVendedor != null) {
                ...
                for (JsonElement registro : registros) {
                    ...
                    Object[] fila = new Object[]{documento, nombre, correo, rol, estado};
                    modelo.addRow(fila);
    ...
    private void consumoVendedores() {
        ...
        if (respuesta != null) {
            ...
            for (int i = 0; i < registros.size(); i++) {
                ...
                String contrasenia = registro.get("contrasenia").getAsString();
                ...
                if (rol.equalsIgnoreCase("vendedor")) {
                    ...
                    Object[] temporal = new Object[]{cedula, nombre, correo, contrasenia, rol, estado};
